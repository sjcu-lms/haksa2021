...
(0, _util.extend)(_ChartInternal2.default.prototype, {
  ...
  */
	initTooltip: function initTooltip() {
		...
		if ($$.tooltip = $$.selectChart.style("position", "absolute").append("div").attr("class", _classes2.default.tooltipContainer).style("position", "absolute").style("pointer-events", "none").style("display", "none"), config.tooltip_init_show) {
  ...
  */
	showTooltip: function showTooltip(selectedData, element) {
		...
		if (dataToShow.length !== 0 && config.tooltip_show) {
				...
				$$.tooltip.style("top", position.top + "px").style("left", position.left + "px").style("z-index","999");
			}
